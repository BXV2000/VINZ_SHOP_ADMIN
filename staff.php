                    ...
                    {?>   
                        <tr class="">
                            ...
                            <td class="column btn_wrapper" >
                                <form class="action_form" action="./staff.php?edit=<?php echo $product['MSHH']?>" method="POST" > 
                                    <button class="small_btn edit_btn btn_no_default" name="edit"><i class="fas fa-pen"></i></button>
                                </form>
                                <form class="action_form" action="./staff.php?delete=<?php echo $product['MSHH']?>" method="POST" onsubmit="return confirm('Bạn có muốn xóa <?php echo $product['TenHH']?>?');">
